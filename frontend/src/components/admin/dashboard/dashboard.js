    ...
    <div style={{ width: "100%" }}>
      ...
      <div className="account">
        ...
        <div className="detail">
          <div className="conts">
            <h4>FullName </h4>
            <input type="text" className="inp" value="Aman Prateek" />
          </div>
          <div className="conts">
            <h4>Email Id </h4>
            <input type="text" className="inp" value="amanpra333@gmail.com" />
          </div>
          <div className="conts">
            <h4>Contact No. </h4>
            <input type="text" className="inp" value="9625341429" />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      <div className="dashing">
        <div className="left">
          <div className="welcome-section" onClick={() => handle(0, "Profile")}>
            <img
          ...
          <div
            ...
            onClick={() => handle(3, "Manage Admins")}
          >
            <i class="fa fa-user-circle" aria-hidden="true"></i>
            <span className="span">Manage Admins</span>
          </div>
          <div
            className={tab === 4 ? "features-icons" : "features-icons1"}
            onClick={() => handle(4, "Settings")}
          >
        ...
        <div className="right">
          ...
          {tab === 0 ? profile : tab === 5 ? dashboard : null}
        </div>
      </div>
    </div>
  );
