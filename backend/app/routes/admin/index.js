...
const { postSuperAdminSchema, getAdminsSchema, passwordChangeSchema, putAdminSchema } = require('./@validationSchema');
...
router.put('/admin', validationMiddleware(putAdminSchema), authMiddleware, putAdmin);
