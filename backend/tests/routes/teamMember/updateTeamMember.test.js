...
describe('update team member from DB',()=> {
    let token = ''
    let id = ''
    ...
    //step 3 : Updating team member
    it("Updating team member from DB",(done)=> {
        const testData = {
            teamMemberId:id,
            full_name : "Shubhamasdfadsfst",
            description :"This is for testing the api" ,  
            linkedlin_url : "https//www.linkedin.in/AmanTest", 
            github_url : "https/www.github.com/Aman16-ai", 
            twitter_url : "https/www.tiwtter.com/Amanteset", 
        ...
        chai
            .request(server)
            .put('/teamMember/updateTeamMember')
            .set('Authorization', `Bearer ${token}`)
            .set('content-type','multipart/form-data')
            .field("teamMemberId",testData.teamMemberId)
            ...
            .field("teams",testData.teams)
            .attach('image',"./tests/utils/file2.png",'file2.png')
            .end((err,res)=> {
