...
export const PrivacyPolicy = (props) => {
  ...
  return (
    <body id={dark ? `${style["main-dark"]}` : style["main"]}>
      <div className={style["pp-section"]}>
        ...
        <div className={style["pp-statement-container"]}>
          <div className={style["pp-statement"]}>
            <div
              className={
                dark ? `${style["pp-content-dark"]}` : style["pp-content"]
              }
            >
            ...
            <div
              className={
                dark ? `${style["pp-subheading-dark"]}` : style["pp-subheading"]
              }
            >
            ...
            >
              ...
              be asked to enter your name, email address, mailing address or
            ...
            >
              ...
              <ul>
                <li>
                  <i className="far fa-hand-point-right"></i> To personalize
            ...
            >
              <ul>
                ...
                <li>
                  <i className="fas fa-check-circle"></i> We only provide
                  articles and information. We never ask for credit card
                  numbers.
                </li>
                <li>
            ...
            >
              ...
              <p
                className={dark ? `${style["by-line-dark"]}` : style["by-line"]}
              >
