  ...
  return (
    <main className={dark ? style["main-dark"] : style["main"]}>
      <div>
        <div
          className={
            dark ? style["terms-section-dark"] : style["terms-section"]
          }
        >
          <img src="./images/terms.png" alt="" className={style["terms-img"]} />
        </div>
        <div className={dark ? style["terms-dark"] : style["terms"]}>
          <div className="row text-center">
            <h1>Terms Of Use</h1>
          </div>
        </div>
        <div className={dark ? style["agreement-dark"] : style["agreement"]}>
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <p>
                <b>
                  ...
                  into these Terms. IF YOU DISAGREE WITH ALL OF THE PROVISION OF
                  THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.
                </b>
              </p>
              <p>
                <b> Access to the Site is subject to these Terms:</b> <br />
                Community grants you a non-transferable, non-exclusive,
              ...
              <p>
                ...
                Community will have no obligation to provide you with any
                support in connection with the Site. Excluding any User Content
                that you may provide, you are aware that all the intellectual
                property rights, including copyrights, patents, trademarks, and
                trade secrets, in the Site and its content are owned by
                Community or Community’s suppliers. Note that these Terms and
                access to the Site do not give you any rights, title or interest
                in or to any intellectual property rights, except for the
                limited access rights expressed in Section 2.1. Community and
                its suppliers reserve all rights not granted in these Terms.
              </p>
              <p>
                <b>User Content</b> <br />
                "User Content" means any and all information and content that a
                user submits to the Site. You are exclusively responsible for
                your User Content. You bear all risks associated with use of
                your User Content. You hereby certify that your User Content
                does not violate our Acceptable Use Policy. You may not
                represent or imply to others that your User Content is in any
                way provided, sponsored or endorsed by the Community. Because
                you alone are responsible for your User Content, you may expose
                yourself to liability. Community is not obliged to backup any
                User Content that you post; also, your User Content may be
              ...
              <p>
                ...
                <br /> The following terms constitute our "Acceptable Use
                Policy": You agree not to use the Site to collect, upload,
                ...
                any group or individual; (iii) that is harmful to minors in any
              ...
              <p>
                ...
                and/or display advertisements for third-parties. Such
                Third-Party Links & Ads are not under the control of Community,
                and Community is not responsible for any Third-Party Links &
                Ads. Community provides access to these Third-Party Links & Ads
              ...
              <p>
                ...
                make no guarantee that the site will meet your requirements,
              ...
              <p>
                ...
                community or our suppliers be liable to you or any third-party
                ...
                even if community has been advised of the possibility of such
              ...
              <p>
                ...
                associated with your Account from our live databases. Community
              ...
              <p>
                ...
                following our dispatch of an email notice to you or thirty (30)
              ...
              <p>
                ...
                All claims and disputes in connection with the Terms or the use
                of any product or service provided by the community that cannot
                be resolved informally or in small claims court shall be
                ...
                Arbitration Agreement applies to you and the community, and to
                any subsidiaries, affiliates, agents, employees, predecessors in
                interest, successors, and assigns, as well as all authorised or
                unauthorised users or beneficiaries of services or goods
                provided under the Terms.
              </p>
              <p>
                <b>Notice Requirement and Informal Dispute Resolution:</b>{" "}
                <br /> Before either party may seek arbitration, the party must
                first send to the other party a written Notice of Dispute
                describing the nature and basis of the claim or dispute, and the
                requested relief. A Notice to the community should be sent to:
                Kolkata, West Bengal 700107, India. After the Notice is
                received, you and the community may attempt to resolve the claim
                or dispute informally. If you and the community do not resolve
              ...
              <p>
                ...
                the community posts notices on the Site or communicates with you
                via email. For contractual purposes, you (a) consent to receive
                communications from community in an electronic form; and (b)
                agree that all terms and conditions, agreements, notices,
                disclosures, and other communications that community provides to
              ...
              <p>
                ...
                the maximum extent permitted by law. Your relationship to the
                community is that of an independent contractor, and neither
                party is an agent or partner of the other. These Terms, and your
                rights and obligations herein, may not be assigned,
                subcontracted, delegated, or otherwise transferred by you
                without community’s prior written consent, and any attempted
                assignment, subcontract, delegation, or transfer in violation of
                the foregoing will be null and void. Community may freely assign
              ...
              <p
                className={
                  dark ? style["contact-info-dark"] : style["contact-info"]
                }
              >
