      ...
      <div className={style["agreement"]}>
        <div className="row">
          ...
          <div className="col-lg-8">
            ...
            <p>
              The HITK Tech Community website located at{" "}
              <a
                href="https://github.com/HITK-TECH-Community/Community-Website"
                alt="hitk-community-website"
              >
                https://github.com/HITK-TECH-Community/Community-Website{" "}
              </a>{" "}
              is a copyrighted work belonging to HITK Tech Community. Certain
              ...
              with such features. All such additional terms, guidelines, and
            ...
            <p>
              <b>
                ...
                these Terms. IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE
                TERMS, DO NOT LOG INTO AND/OR USE THE SITE.
              </b>
            </p>
            <p>
              <b> Access to the Site is subject to these Terms:</b> <br />
              Community grants you a non-transferable, non-exclusive, revocable,
              limited license to access the Site solely for your own personal,
              noncommercial use.
            </p>
            <p>
              <b> Certain Restrictions: </b> <br />
              ...
              of, disassemble, reverse compile or reverse engineer any part of
              the Site; (c) you shall not access the Site in order to build a
              similar or competitive website; and (d) except as expressly stated
            ...
            <p>
              <b> No Support or Maintenance:</b> <br /> You agree that the
              Community will have no obligation to provide you with any support
              in connection with the Site. Excluding any User Content that you
              may provide, you are aware that all the intellectual property
              rights, including copyrights, patents, trademarks, and trade
              secrets, in the Site and its content are owned by Community or
              Community’s suppliers. Note that these Terms and access to the
              Site do not give you any rights, title or interest in or to any
              intellectual property rights, except for the limited access rights
              expressed in Section 2.1. Community and its suppliers reserve all
              rights not granted in these Terms.
            </p>
            <p>
              <b>User Content</b> <br />
              "User Content" means any and all information and content that a
              user submits to the Site. You are exclusively responsible for your
              User Content. You bear all risks associated with use of your User
              Content. You hereby certify that your User Content does not
              violate our Acceptable Use Policy. You may not represent or imply
              to others that your User Content is in any way provided, sponsored
              or endorsed by the Community. Because you alone are responsible
              for your User Content, you may expose yourself to liability.
              Community is not obliged to backup any User Content that you post;
              also, your User Content may be deleted at any time without prior
              notice to you. You are solely responsible for making your own
              backup copies of your User Content if you desire.
            </p>
            <p>
              <b>Acceptable Use Policy:</b>
              <br /> The following terms constitute our "Acceptable Use Policy":
              ...
              individual; (iii) that is harmful to minors in any way; or (iv)
            ...
            <p>
              ...
              Links & Ads are not under the control of Community, and Community
              is not responsible for any Third-Party Links & Ads. Community
            ...
            <p>
              ...
              community and our suppliers expressly disclaim any and all
              ...
              make no guarantee that the site will meet your requirements, will
            ...
            <p>
              ...
              community or our suppliers be liable to you or any third-party for
              ...
              community has been advised of the possibility of such damages.
            ...
            <p>
              ...
              may involve deletion of your User Content associated with your
              Account from our live databases. Community will not have any
            ...
            <p>
              ...
              providing us with your most current email address. In the event
              that the last e-mail address that you have provided us is not
              ...
              the earliest of thirty (30) calendar days following our dispatch
              of an email notice to you or thirty (30) calendar days following
              our posting of notice of the changes on our Site. These changes
              will be effective immediately for new users of our Site. Continued
            ...
            <p>
              <b>Applicability of Arbitration Agreement:</b> <br />
              All claims and disputes in connection with the Terms or the use of
              any product or service provided by the community that cannot be
              ...
              applies to you and the community, and to any subsidiaries,
              affiliates, agents, employees, predecessors in interest,
              successors, and assigns, as well as all authorised or unauthorised
              users or beneficiaries of services or goods provided under the
              Terms.
            </p>
            <p>
              <b>Notice Requirement and Informal Dispute Resolution:</b> <br />{" "}
              ...
              relief. A Notice to the community should be sent to: Kolkata, West
              Bengal 700107, India. After the Notice is received, you and the
              community may attempt to resolve the claim or dispute informally.
              If you and the community do not resolve the claim or dispute
              within thirty (30) days after the Notice is received, either party
              may begin an arbitration proceeding. The amount of any settlement
              offer made by any party may not be disclosed to the arbitrator
              until after the arbitrator has determined the amount of the award
              to which either party is entitled.
            </p>
            <p>
              <b>Electronic Communications: </b> <br />
              The communications between you and the community use electronic
              means, whether you use the Site or send us emails, or whether the
              community posts notices on the Site or communicates with you via
              email. For contractual purposes, you (a) consent to receive
              communications from community in an electronic form; and (b) agree
              that all terms and conditions, agreements, notices, disclosures,
              and other communications that community provides to you
              electronically satisfy any legal obligation that such
            ...
            <p>
              ...
              extent permitted by law. Your relationship to the community is
              ...
              or otherwise transferred by you without community’s prior written
              ...
              Community may freely assign these Terms. The terms and conditions
