  ...
  return (
    <div className="pp-section">
      <div className="pp-logo-container">
        <img className="pp-logo" src="./images/privacy.png" alt="privacy-icon" />
      </div>
      <div className="pp-statement-container">
          ...
          <div className="pp-subheading">What personal information do we collect from the people that visit our website?</div>
          <div className="pp-content">
          ...
          <div className="pp-subheading">When do we collect information?</div>
          <div className="pp-content">
          We collect information from you when you register on our site, subscribe to a newsletter, fill out a form or enter information on our site.
          </div>
          <div className="pp-subheading">How do we use your information?</div>
          <div className="pp-content">
          ...
          <div className="pp-subheading">CAN SPAM Act</div>
          <div className="pp-content">
          The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.
          </div>
          <div className="pp-subheading">We collect your email address in order to:</div>
          <div className="pp-content">
          Send information, respond to inquiries, and/or other requests or questions.
          </div>
          <div className="pp-subheading">To be in accordance with CANSPAM, we agree to the following:</div>
          <div className="pp-content">
          If at any time you would like to unsubscribe from receiving future emails, you can email us at <a href="mailto:hitktechcommunity@gmail.com">hitktechcommunity@gmail.com</a> and we will promptly remove you from ALL correspondence.
          </div>
          <div className="pp-subheading">Contacting Us</div>
          <div className="pp-content">
